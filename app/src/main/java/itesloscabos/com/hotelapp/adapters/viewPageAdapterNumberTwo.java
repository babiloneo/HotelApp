...
/**
 * Created by croni on 07/06/2017.
 */

public class viewPageAdapterNumberTwo extends PagerAdapter {

    private Context context;
    private LayoutInflater layoutInflater;
    private List<indexImagenes> lista;
    public viewPageAdapterNumberTwo(@NonNull Context context , @NonNull List<indexImagenes> lis) {
